...
WebUI.setText(findTestObject('Object Repository/ALTAUSUARIO/WEBTABLE/button_searchBox'), 'Cierra')
...
WebUI.doubleClick(findTestObject('Object Repository/ALTAUSUARIO/FORMULARIO/input_firstName'))

WebUI.clearText(findTestObject('Object Repository/ALTAUSUARIO/FORMULARIO/input_firstName'))

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/ALTAUSUARIO/FORMULARIO/input_firstName'), 'required', 1)
